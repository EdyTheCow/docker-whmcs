...
# 👓 Quick Overview
The `_base` directory currently only includes Traefik. If you're already using Traefik, you can use it as a guide and plug & play the `whmcs` part into your existing setup. 
